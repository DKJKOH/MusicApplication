...
void DeckGUI::resized()
{
    ...
    volSliderLabel.setBounds(0, rowH * 2, sliderWidthColumn, labelOffsetValue);
    volSlider.setBounds(0, rowH * 2 + labelOffsetValue, sliderWidthColumn, rowH * 2 - labelOffsetValue);

    // Sets the position of the speedSlider and speedSliderLabel
    speedSliderLabel.setBounds(sliderWidthColumn, rowH * 2, sliderWidthColumn, rowH * 2);
    speedSlider.setBounds(sliderWidthColumn, rowH * 2 + labelOffsetValue, sliderWidthColumn, rowH * 2 - labelOffsetValue);

    // Sets the position of the reverbSlider and reverbSliderLabel
    reverbSliderDampLabel.setBounds(sliderWidthColumn * 2, rowH * 2, sliderWidthColumn, rowH * 2);
    reverbSliderDamp.setBounds(sliderWidthColumn * 2, rowH * 2 + labelOffsetValue, sliderWidthColumn, rowH * 2 - labelOffsetValue);

    // Sets the position of the dry level slider and dry level slider label
    reverbDryLevelSliderLabel.setBounds(0, rowH * 4, sliderWidthColumn, rowH * 2);
    reverbDryLevelSlider.setBounds(0, rowH * 4 + labelOffsetValue, sliderWidthColumn, rowH * 2 - labelOffsetValue);

    // Sets the position of the wet level slider and wet level slider label
    reverbWetLevelSliderLabel.setBounds(sliderWidthColumn, rowH * 4, sliderWidthColumn, rowH * 2);
    reverbWetLevelSlider.setBounds(sliderWidthColumn, rowH * 4 + labelOffsetValue, sliderWidthColumn, rowH * 2 - labelOffsetValue);

    // Sets the position of the room size level slider and wet level slider label
    reverbRoomSizeSliderLabel.setBounds(sliderWidthColumn * 2, rowH * 4, sliderWidthColumn, rowH * 2);
    reverbRoomSizeSlider.setBounds(sliderWidthColumn * 2    , rowH * 4 + labelOffsetValue, sliderWidthColumn, rowH * 2 - labelOffsetValue);

    // Sets position of position slider
    posSlider.setBounds(60, rowH * 6, sliderWidthColumn * 2, rowH - 4);

    // Set position and size of loopCheckbox
    loopCheckbox.setBounds(sliderWidthColumn * 2 + 65, rowH * 6, sliderWidthColumn - 65, rowH);

    // Set size of the play button if user resizes the window
    playButton.setBounds(0, rowH * 7, sliderWidthColumn, rowH);

    // Set size of the play button if user resizes the window
    stopButton.setBounds(sliderWidthColumn, rowH * 7, sliderWidthColumn, rowH);

    // Set size of load button if user resizes the window
    loadButton.setBounds(sliderWidthColumn * 2, rowH * 7, sliderWidthColumn, rowH);
