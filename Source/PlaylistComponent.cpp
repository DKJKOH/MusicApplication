...

{
    ...
    tableComponent.getHeader().addColumn("Play Right Track", 4, 100);
    // Column 5 Load Music button
    tableComponent.getHeader().addColumn("Load Music", 5, 200);
    ...
    bool rowIsSelected)
{
    ...
    {
        // Non-selected row will have a dark grey fill
    ...
    bool rowIsSelected)
{
    ...
    if (columnId == 1 && rowNumber < getNumRows())
    {
        g.drawText(
